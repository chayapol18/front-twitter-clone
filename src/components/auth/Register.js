import { Box, Button, Flex, Stack, Input, IconButton, Text, Lorem, Select,FormControl, FormLabel, FormHelperText, InputGroup, InputRightElement, HStack  } from "@chakra-ui/react";
...
const SignupModal = ({input, setInput, handleInputChange, handleSubmit, birthDate, setBirthDate }) => {
    ...
    return (
        <>
        <Button onClick={onOpen} borderRadius='40px' bgColor='blue.400' color='white' h='45px'>
            Sign up
        </Button>
        <Modal isOpen={isOpen} onClose={onClose} size='xl'>
            ...
            <ModalContent>
            <ModalHeader>
                <IconButton variant="none" as={FaTwitter} w='30px' h='30px' ml='230px' color="blue.400" mb='15px'/>
                      ...
                      <FormControl id='confirmPassword' isRequired>
                        ...
                        <InputGroup>
                            ...
                            <InputRightElement>
                                <Button variant="none" onClick={handleClick} fontSize='10px' _focus={{ borderStyle:'none' }} >
                                {show ? 
                                <IconButton variant="none" icon={<ViewOffIcon />} _focus={{ borderStyle:'none' }} /> : 
                                <IconButton variant="none" icon={<ViewIcon />} _focus={{ borderStyle:'none' }} /> }
                                </Button>
                            </InputRightElement>
                        </InputGroup>
                      </FormControl>
...
function Register() {
    ...
    return (
        <Flex direction='column'>
            <IconButton variant="none" as={FaTwitter} w='45px' h='45px' color="blue.400" mt='15px' ml='0'/>
            ...
            <Flex direction='column' w='60%' mt='30px'>
                <Stack spacing={5} >
                    ...
                    <Button borderRadius='40px' bgColor='white' color='blue.400' border='solid 1px' h='45px' onClick={handleLogin}>Log in</Button>
                </Stack>    
            </Flex>
        </Flex>
    )
