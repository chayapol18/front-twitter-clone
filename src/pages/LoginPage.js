...
function LoginPage() {
    ...
    return(
        <Flex direction='column' mt='20px' alignItems='center'>
            <IconButton variant="none" as={FaTwitter} w='40px' h='40px' color="blue.400" ml='-330px' mb='25px'/>
            <Text fontWeight='700' fontSize='35px' mb='25px' ml='-100px'>Log in to Twitter</Text>
            <Input placeholder='Username or Email' w='380px' h='60px' mb='25px' value={emailOrUsername} onChange={(e) => setEmailOrUsername(e.target.value)}></Input>
            <InputGroup w='380px' mb='25px'>
                <Input
            ...
            <Button borderRadius='40px' bgColor='blue.400' color='white' h='45px' w='380px' mb='35px' onClick={handleLogin}>Log in</Button>
            <Flex direction='row'>
